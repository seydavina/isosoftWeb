...
const features = {
  base: [
    ...
    "Familles",
    "Tarifs",
    "Saisies nomenclatures",
  ],
  systeme: [
    "Accès dépôts",
    "Accès souches",
    "Accès documents",
    "Interdiction Saisie docs ventes",
    "Interdiction Saisie docs retours",
    "Modif / Support docs",
  ],
  traitement: [
    "Blocage tiers",
  ...
  comptable: [
    ...
    "Association pièces / comptes",
    "Génération des factures en écritures",
  ],
};

const columns = [
  {
    image: { src: "/images/illustrations/isogescom-base.png", alt: "Base GESCOM" },
    sections: [
      { title: "Menu Fichier de base", features: features.base },
      { title: "Menu Système", features: features.systeme },
      { title: "Menu Traitement", features: features.traitement },
    ],
  },
  {
    image: {
      src: "/images/illustrations/isogescom-stats.png",
      alt: "Statistiques GESCOM",
    },
    sections: [
      { title: "Menu Comptabilisation", features: features.comptabilisation },
      { title: "Menu États", features: features.etats },
      { title: "Menu Fichier Comptable", features: features.comptable },
    ],
  },
];
      ...
      <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        <header class="mx-auto max-w-2xl text-center header-content">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Gestion commerciale. Pilotez vos ventes, vos achats et vos stocks en toute
            simplicité grâce à une interface claire et des fonctionnalités avancées.
          </p>
        </header>
