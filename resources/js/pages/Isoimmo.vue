...
const features = {
    enregistrement: ['Enregistrement des immobilisations', 'Classification des actifs', "Historique d'acquisition"],
    amortissement: ['Calcul automatique des amortissements', 'Méthodes dégressives et linéaires', 'Suivi des amortissements cumulés'],
    inventaire: ['Inventaires périodiques', 'Mises à jour de la valorisation', 'Alertes de réévaluation'],
};

const columns = [
    {
        image: {
            src: '/images/illustrations/isoimmo-immobilisations.png',
            alt: 'Gestion des immobilisations',
        },
        sections: [
            { title: 'Menu Enregistrement', features: features.enregistrement },
            { title: 'Menu Amortissement', features: features.amortissement },
        ],
    },
    {
        image: {
            src: '/images/illustrations/isoimmo-inventaire.png',
            alt: 'Inventaire et valorisation',
        },
        sections: [{ title: 'Menu Inventaire', features: features.inventaire }],
    },
];
            ...
            <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
                <header class="header-content mx-auto max-w-2xl text-center">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        Gestion intégrée des immobilisations. Suivez, amortissez et gérez vos actifs en toute simplicité.
                    </p>
                </header>
                <div class="relative mx-auto mt-20">
                    <div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
                        <!-- Chaque colonne est un conteneur flex-col avec un espacement vertical constant -->
