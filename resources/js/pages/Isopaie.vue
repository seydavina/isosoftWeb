...
/**
 * Example data structure for ISOPAIE.
 * Adjust these lists according to your actual menus.
 */
const features = {
  tablesDeBase: [
    "Paramètres généraux",
    ...
    "Modèles bulletins",
    "Rubriques",
    "Rubriques super bruts",
    "Paramétrage modèles salaires",
    "Paramétrage sections professionnelles",
  ],
  comptabilisation: [
    "Paramétrage de déversement",
    "Lancement contrôle déversement",
    "Visualisation Contrôle déversement",
    "Comptabilisation paie",
  ],
  traitement: [
    "Gestion modèles bulletins",
    "Éléments de paie",
    "Paie mensuelle / Échelonnée",
    "Lancement calcul et éditions bulletins",
    "Validation paie",
    "Fiches salariés",
    "Réduction barèmes",
    "Calcul primes",
  ...
  etats: [
    "Édition bulletins",
    "Calcul des net à payer",
    "Fiche 1014",
    "Provisions Congés / Provisions Retraite",
  ],
};

/**
 * Two columns, each with an image and a set of sections.
 * Adjust the images to your actual paths.
 */
const columns = [
  {
    image: {
      src: "/images/illustrations/isopaie-base.png",
      alt: "Base Paie",
    },
    sections: [
      { title: "Menu Tables de base", features: features.tablesDeBase },
      { title: "Menu Comptabilisation", features: features.comptabilisation },
    ],
  },
  {
    image: {
      src: "/images/illustrations/isopaie-treatment.png",
      alt: "Traitements de la Paie",
    },
    sections: [
      { title: "Menu Traitement", features: features.traitement },
      { title: "Menu États", features: features.etats },
    ],
  },
];
...
<template>
  <div>
    ...
    >
      <!-- Overlay (optional decorative grid) -->
      ...
      <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        <header class="mx-auto max-w-2xl text-center header-content">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Gestion de la paie adaptée à toutes les entreprises. Gérez salaires, primes,
            retenues, et bien plus grâce à un module complet et performant.
          </p>
        </header>
