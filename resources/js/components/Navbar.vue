  ...
  <nav class="bg-white/95 backdrop-blur-sm shadow-sm fixed w-full z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-20">
        ...
        <div class="flex items-center">
          <Link
            href="/"
            class="inline-flex items-center transition-transform duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 rounded-lg"
          >
            <img
              src="/images/logos/logo-default.jpg"
              alt="ISOSOFT"
              class="h-10 w-auto"
              loading="lazy"
            />
        ...
        <div class="hidden sm:flex sm:items-center sm:space-x-8">
          ...
          >
            ...
            >
              <div
                ...
                class="absolute left-0 top-full mt-2 w-64 rounded-lg shadow-lg bg-white/95 backdrop-blur-sm ring-1 ring-black/5 z-50"
              >
          ...
          <Link
            ...
            :key="link.href"
            :href="link.href"
            class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors duration-200 focus:outline-none focus:underline"
          >
            {{ link.text }}
          </Link>
          ...
          <Link
            href="/contact"
            class="ml-6 inline-flex items-center px-6 py-2.5 border border-transparent text-sm font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 transition-all duration-200 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
          >
            Nous contacter
          </Link>
        </div>
        ...
        <div class="flex items-center sm:hidden">
          <button
            ...
            class="p-2 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200"
            aria-label="Menu"
    ...
    >
      <div
        ...
        class="sm:hidden bg-white/95 backdrop-blur-sm shadow-lg"
      >
        <div class="pt-2 pb-3 space-y-1">
          ...
          <div>
            <button
              ...
              class="w-full px-4 py-3 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50/80 transition-colors duration-200 flex items-center justify-between focus:outline-none focus:bg-gray-50/80"
              :aria-expanded="isServicesDropdownOpen"
            >
              Services
              <svg
